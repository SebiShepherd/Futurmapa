...
const DATA_CONFIG = {
  ...
  "continents": {
    "Nordamerika": {
      ...
      "description": "In Nordamerika befinden sich die zentralen Hubs für Strategie und Innovation. Der Markt zeichnet sich durch hohe Dynamik und komplexe Lieferketten aus."
    },
    "Südamerika": {
      "countries": [
        "BRA",
      ...
      "description": "Wachstumsmärkte mit Fokus auf Ausbau der Vertriebspräsenz und nachhaltigen Lieferketten."
    },
    "Europa": {
      "countries": [
        "DEU",
      ...
      "description": "Der europäische Verbund bündelt Produktion, F&E sowie zentrale Shared Services."
    },
    "Afrika & Mittlerer Osten": {
      ...
      "description": "Region mit Fokus auf Partnerschaften, skalierbare Service-Modelle und Talentaufbau."
    },
    "Asien-Pazifik": {
      "countries": [
        "CHN",
      ...
      "description": "APAC vereint starke Fertigungskapazitäten mit digital geprägten Vertriebsmodellen."
    }
  },
  "countries": {
    "USA": {
      ...
      "active": true,
      "overview": "Zentraler Markt mit Headquarter-Funktionen in Finance, HR-Strategie und globalem Vertrieb.",
      "points": [
        {
          "id": "usa-finance",
          "title": "Finance Hub",
          ...
          "data": {
            "Group": {
              "summary": "Die Gruppe konsolidiert in den USA 42 % des globalen Umsatzes. Der Fokus liegt auf margenstarken Servicepaketen und einer vorsichtigen Kostenbasis.",
              "metrics": [
                {
                  "label": "Umsatz Q2",
                  "value": "$12,4 Mrd.",
              ...
              "progress": [
                {
                  "label": "Integrationsprogramm Fusion",
                  "value": 72
                },
                {
                  "label": "Digitalisierungsbudget genutzt",
                  "value": 64
                }
              ]
            },
            "CVS": {
              "summary": "CVS adressiert den Enterprise-Sektor mit Fokus auf Managed Services und Cloud-Plattformen.",
              "metrics": [
                {
                  "label": "ARR",
                  "value": "$7,1 Mrd.",
              ...
              "progress": [
                {
                  "label": "Abschluss SAP S/4 Migration",
                  "value": 88
                },
                {
                  "label": "Green-Bond-Mittel gebunden",
                  "value": 54
                }
              ]
            },
            "RVS": {
              "summary": "RVS skaliert Serviceleistungen im öffentlichen Sektor und Gesundheitswesen.",
              "metrics": [
                {
                  "label": "Projekt-Pipeline",
                  "value": "$5,3 Mrd.",
                  "trend": "+9 %"
                },
                {
              ...
              "progress": [
                {
                  "label": "Standorte mit Nearshore-Abdeckung",
                  "value": 61
                }
              ]
            },
        ...
        },
        {
          ...
          "data": {
            "Group": {
              "summary": "Der globale People Excellence Campus adressiert Upskilling in Datenkompetenzen und Leadership.",
              "metrics": [
                {
                  "label": "FTE gesamt",
                  "value": "38.400",
              ...
              "progress": [
                ...
                {
                  "label": "Absolventen Future Leaders Program",
                  "value": 64
                }
              ]
            },
            "CVS": null,
            "RVS": {
              "summary": "RVS erweitert das klinische Expertennetzwerk mit Fokus auf TeleHealth.",
              "metrics": [
                {
                  "label": "Fachkräfte-Aufbau",
                  "value": "+1.240 Köpfe",
                  "trend": "+12 %"
                },
                {
                  "label": "Weiterbildungsstunden",
                  "value": "86.000",
                  "trend": "+18 %"
                }
              ]
      ...
      "points": [
        {
          ...
          "data": {
            "Group": {
              "summary": "Das kanadische Delivery Center unterstützt globale Programme in den Bereichen Klimabilanz und KI-Automatisierung.",
              "metrics": [
                {
                  "label": "CO₂-Einsparung",
                  "value": "−32 %",
              ...
              "progress": [
                {
                  "label": "Scope-3 Abdeckung",
                  "value": 66
                },
                {
                  "label": "Lieferanten mit ESG-Audit",
                  "value": 74
                }
              ]
            },
      ...
      "points": [
        {
          ...
          "data": {
            "Group": {
              "summary": "Die Gruppe investiert in lokale Partnerschaften und digitale Marktplätze.",
              "metrics": [
                {
                  "label": "Neukunden 2024",
                  "value": "+38 %",
                  "trend": "+8 PP"
                },
                {
      ...
      "points": [
        {
          ...
          "data": {
            "Group": {
              "summary": "Deutschland ist Sitz der Konzern-AG mit Fokus auf Profitabilität und Transformation.",
              "metrics": [
                {
        ...
        },
        {
          ...
          "data": {
            "Group": {
              "summary": "Fokus auf Tech-Akademien und Dual-Studiengänge.",
              "metrics": [
                {
                  "label": "Tech Trainees",
                  "value": "680",
